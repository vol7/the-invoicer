    ...
    return (
      <div>
        ...
        <button
          ...
          className="block text-white w-full font-bold py-4 -my-4 focus:outline-none"
        >
          + Add item
        </button>
  ...
  return bindActionCreators(
    {
      ...
      moveItem: invoiceActions.moveItem,
    },
    dispatch
  );
}
...
export default DragDropContext(HTML5Backend)(
  connect(mapStateToProps, mapDispatchToProps)(FormItemList)
);
